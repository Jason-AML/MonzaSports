...
export const ModalControl = ({ action, children, color = "#00D3BB" }) => {
  ...
  return (
    <div>
      <button
        className={`btn bg-[${color}]  lg:flex items-center gap-2 px-5 py-2.5   text-xs font-bold uppercase tracking-widest rounded-lg transition-transform hover:scale-105`}
